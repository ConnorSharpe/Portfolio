...
> I build things that work, ship things that matter, and produce such clean code that it could be slam poetry. Currently thinking hard about how to make Large Language Models less thirsty.
...
>
> I started by rebuilding that same software bootcamp from scratch - nav menus, progress bars, notification systems, anything that I would have wanted based on my experience as a student. Then I spent three years at a healthcare software company leading an offshore Angular team, building .NET APIs, and making sure our security practices met OWASP standards.
>
> Most recently I've been doing something that didn't really have a job title a few years ago: building the systems that make AI agents behave better without guardrails. Evaluation pipelines, context isolation patterns, structured handoff protocols. I use Claude, ChatGPT, and Grok as structured reasoning collaborators across workflows to make sure specs are bulletproof before implementation ever begins.
>
> Funnily enough, my dusty old English degree is weirdly paying off in the Tech World of 2026. I like to think that every Claude instance spends its first few tokens thinking "Good Lord this prompt is well-written. This guy is A-OK."
